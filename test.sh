...
docker ps -q --filter "name=nlp2022-hw1" | grep -q . && docker stop nlp2022-hw1
...
# stop container
docker stop nlp2022-hw1

# dump container logs
docker logs -t nlp2022-hw1 > logs/server.stdout 2> logs/server.stderr

# remove container
docker rm nlp2022-hw1
